...
(function() {
  var ButtonAnchor, ButtonForm, ButtonFrame, ButtonFrameContent, CONFIG_ANCHOR_CLASS, CONFIG_API, CONFIG_ICON_CLASS, CONFIG_ICON_DEFAULT, CONFIG_URL, CONFIG_UUID, Code, Deferred, Element, EventTarget, FlatObject, Form, Frame, GitHubAPIStatus, Hash, PreviewAnchor, PreviewFrame, QueryString, document, window,
    slice = [].slice,
  ...
  ButtonForm = (function(superClass) {
    ...
    ButtonForm.prototype.parse = function(options) {
      ...
      config = {
        ...
        text: "Deploy to Dimension Data Cloud",
        data: {
          icon: "octicon-cloud-upload"
        },
        aria: {
          label: "Dimension Data Cloud"
        }
      };
      ...
      if ((options["standard-icon"] != null) || config.data.icon === "octicon-cloud-upload") {
